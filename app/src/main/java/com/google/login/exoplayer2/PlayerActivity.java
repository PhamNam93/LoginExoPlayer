 ...
 */
package com.google.login.exoplayer2;
...
import com.google.login.R;
import com.google.login.track_selection_dialog.TrackSelectionDialog;
...
//      drmSessionManager.setPropertyString("Authorization", "Bearer ya29.a0ARrdaM-KDm0gCBX9SRzh3T-UidPYRoY2oVThGcA0Gl_Tsa3BpZAfpODQX8CR08lhnuGEQXg7vjktdJ2Aw9-XDvdYVRvJEq0NNu5X8byc-Qsv6Tsi_Qteo0FhEfxe81y1KoD5CdETQsJA-S_n0W5uj1RZ9vIlJg");;
...
//  }
  ...
  private DefaultDrmSessionManager<FrameworkMediaCrypto> buildDrmSessionManagerV18(UUID uuid, String licenseUrl, String[] keyRequestPropertiesArray, boolean multiSession) throws UnsupportedDrmException {
    ...
    licenseDataSourceFactory.getDefaultRequestProperties().set("Authorization", "Bearer ya29.a0ARrdaM-KDm0gCBX9SRzh3T-UidPYRoY2oVThGcA0Gl_Tsa3BpZAfpODQX8CR08lhnuGEQXg7vjktdJ2Aw9-XDvdYVRvJEq0NNu5X8byc-Qsv6Tsi_Qteo0FhEfxe81y1KoD5CdETQsJA-S_n0W5uj1RZ9vIlJg");
...
//  Họ và tên : Phạm Như Nam
//  Phòng  ban: Công Nghệ
//  Ngày sinh 07/09/1993
//  Giới tính: Nam
//  Đơn vị công tác: Công ty cổ phần Mạng trực tuyến META
//  Số điện thoại: 0963004562
//  Số CMT/CCCD: 033093005822
//  Tỉnh/hành phố: Hưng 	"Mã
//        Tỉnh/
//        Thành phố ()"	"Quận/
//        Huyện"	"Mã Quận/Huyện
//        ()"	"Xã/
